...
('sentencetranslation')"><span><font size="2.5" color="">句子翻译</font></span>
		</a>
			 
		</li>
		<li class="nav_topic">
		<a onclick="set_iframe
('paragraphtranslation')"><span><font size="2.5" color="">段落翻译</font></span>
		</a>
...
('articletranslation')">篇章翻译</a></li>
    ...
    <div id="middle">
      <iframe id="iframe" name="content"width="100%"height="100%"frameborder="0"
		src="wordtranslation.php" style="overflow:auto;"></iframe>
