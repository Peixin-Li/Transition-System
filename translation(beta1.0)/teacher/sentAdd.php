 ...
 if ($_POST['sub_yes']=="确认")
	{
	    ...
	    $query="insert into questions set   test_id=".$_SESSION['id'].",question_text='".$wenti."',answer='".$daan."',mark='".$fenshu."',publish_date='".$publish_date."',q_unit=".$unit.",type='".$type."'";				 //question-sentence,,question_title-test_id
